...
$_['text_description'] = 'Betalsätt i Payson Checkout erbjud dina kunder enkla och säkra betalningar på nätet. I Payson Checkout ingår alla betalsätt som standard! Återkommande kunder kan spara sina kortuppgifter för en smidig köpupplevelse.';
...
$_['entry_countries'] = 'Lista över länder';
...
$_['entry_color_scheme'] = 'Färgschema';
...
$_['entry_iframe_size_height_type'] = 'Procent or px';
...
$_['entry_price_mismatch'] = 'Prisavvikelse i order';
$_['entry_price_mismatch_yes'] = 'ja';
$_['entry_price_mismatch_no'] = 'nej';
$_['terms_and_conditions'] = 'Terms & Conditions';

// Error
$_['error_permission'] = 'Varning: Du har inte behörighet att ändra betalningsmodulen för Payson.';
...
$_['help_status_extension'] = 'Aktivera modulen.';
...
$_['help_color_scheme'] = 'Ange färgschema';
...
$_['help_price_mismatch'] = 'Pending betalning när det är prisavvikelse mellan OpenCart och Payson';
$_['help_totals_to_ignore'] = 'Kommaseparerad lista med ordertillägg som ej skall skickas till Payson';
$_['help_countries'] = 'Lista över länder som en kund kan välja Payson Checkout. Skiftlägeskänsligt, t.ex. använd: SE,NO,DK';
$_['help_order_status'] = 'Ange efter OpenCart efter att kunden har slutfört en betalning eller när en faktura kan skickas. <br />Vänligen kontrollera under Order | History | Comment att texten “Notification is sent, and the order has been readyToShip” är inkluderad.';
$_['help_order_status_shipped'] = 'Meddela Payson att ordern har skickats.<br />Vänligen kontrollera under Order | History | Comment att texten “Notification is sent, and the order has been shipped” är inkluderad.';
$_['help_order_status_canceled'] = 'Meddela Payson att ordern har avbrutits.<br />Vänligen kontrollera under Order | History | Comment att texten “Notification is sent, and the order has been cancelled” är inkluderad.';
$_['help_order_status_refunded'] = 'Meddela Payson att ordern ska krediteras.<br />Vänligen kontrollera under Order | History | Comment att texten “Notification is sent, and the order has been aidToAccount/Krediterad” är inkluderad.';
