...
class Success extends \Opencart\System\Engine\Controller {
    ...
    public function index(): void {
        ...
        if (isset($this->session->data['order_id']) and $this->request->get['paysonStatus'] != 'readyToPay') {
            $this->cart->clear();
        ...
        $data['width'] = $this->config->get('payment_paysoncheckout_iframe_size_width') . $this->config->get('payment_paysoncheckout_iframe_size_width_type');
        $data['height'] = $this->config->get('payment_paysoncheckout_iframe_size_height') . $this->config->get('payment_paysoncheckout_iframe_size_height_type');
        ...
        $this->response->setOutput($this->load->view('extension/oc_payment_paysoncheckout/onecheckout/success', $data));
    }
